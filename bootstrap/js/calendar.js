...
document.write('<tr><td style="cursor:pointer" onclick="csubm()"><i class="icon-caret-left"></i></td><td colspan=5 id="mns" align="center" style="font:bold 13px Arial;text-align:center"></td><td align="right" style="cursor:pointer" onclick="caddm()"><i class="icon-caret-right"></i></td></tr>');
